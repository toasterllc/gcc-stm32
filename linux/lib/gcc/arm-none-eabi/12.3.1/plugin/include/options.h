...
#endif
#ifdef GENERATOR_FILE
extern bool flag_cyclomatic_complexity_info;
#else
  bool x_flag_cyclomatic_complexity_info;
#define flag_cyclomatic_complexity_info global_options.x_flag_cyclomatic_complexity_info
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_cyclomatic_complexity;
#else
  int x_flag_cyclomatic_complexity;
#define flag_cyclomatic_complexity global_options.x_flag_cyclomatic_complexity
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_fcyclomatic_complexity = 1013,         /* -fcyclomatic-complexity */
  ...
  OPT_mapcs = 1767,                          /* -mapcs */
  OPT_mapcs_frame = 1768,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1769,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1770,              /* -mapcs-stack-check */
  OPT_march_ = 1771,                         /* -march= */
  OPT_marm = 1772,                           /* -marm */
  OPT_masm_syntax_unified = 1773,            /* -masm-syntax-unified */
  OPT_mbe32 = 1774,                          /* -mbe32 */
  OPT_mbe8 = 1775,                           /* -mbe8 */
  OPT_mbig_endian = 1776,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1777,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1778,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1779,     /* -mcaller-super-interworking */
  OPT_mcmse = 1780,                          /* -mcmse */
  OPT_mcpu_ = 1781,                          /* -mcpu= */
  OPT_mfdpic = 1782,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1783,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 1784,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 1785, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 1786,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1787,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1788,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1789,                  /* -mfp16-format= */
  OPT_mfpu_ = 1790,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1791,             /* -mgeneral-regs-only */
  /* OPT_mhard_float = 1792, */              /* -mhard-float */
  OPT_mlibarch_ = 1793,                      /* -mlibarch= */
  OPT_mlittle_endian = 1794,                 /* -mlittle-endian */
  OPT_mlong_calls = 1795,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1796,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1797,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1798,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1799,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1800,               /* -mprint-tune-info */
  OPT_mpure_code = 1801,                     /* -mpure-code */
  OPT_mrestrict_it = 1802,                   /* -mrestrict-it */
  OPT_msched_prolog = 1803,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1804,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1805,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1806, */              /* -msoft-float */
  OPT_mstack_protector_guard_offset_ = 1807, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_ = 1808,        /* -mstack-protector-guard= */
  OPT_mstructure_size_boundary_ = 1809,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1810,                         /* -mthumb */
  OPT_mthumb_interwork = 1811,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1812,                  /* -mtls-dialect= */
  OPT_mtp_ = 1813,                           /* -mtp= */
  OPT_mtpcs_frame = 1814,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1815,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1816,                         /* -mtune= */
  OPT_munaligned_access = 1817,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1818,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1819,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1820,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1821,              /* -mword-relocations */
  OPT_n = 1822,                              /* -n */
  ...
  OPT_static_libstdc__ = 1880,               /* -static-libstdc++ */
  OPT_static_libtsan = 1881,                 /* -static-libtsan */
  OPT_static_libubsan = 1882,                /* -static-libubsan */
  OPT_static_pie = 1883,                     /* -static-pie */
  /* OPT_std_c__03 = 1884, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1885, */                /* -std=c++0x */
  OPT_std_c__11 = 1886,                      /* -std=c++11 */
  OPT_std_c__14 = 1887,                      /* -std=c++14 */
  OPT_std_c__17 = 1888,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1889, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1890, */                /* -std=c++1z */
  OPT_std_c__20 = 1891,                      /* -std=c++20 */
  OPT_std_c__23 = 1892,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1893, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1894, */                /* -std=c++2b */
  OPT_std_c__98 = 1895,                      /* -std=c++98 */
  OPT_std_c11 = 1896,                        /* -std=c11 */
  OPT_std_c17 = 1897,                        /* -std=c17 */
  /* OPT_std_c18 = 1898, */                  /* -std=c18 */
  /* OPT_std_c1x = 1899, */                  /* -std=c1x */
  OPT_std_c2x = 1900,                        /* -std=c2x */
  /* OPT_std_c89 = 1901, */                  /* -std=c89 */
  OPT_std_c90 = 1902,                        /* -std=c90 */
  OPT_std_c99 = 1903,                        /* -std=c99 */
  /* OPT_std_c9x = 1904, */                  /* -std=c9x */
  OPT_std_f2003 = 1905,                      /* -std=f2003 */
  OPT_std_f2008 = 1906,                      /* -std=f2008 */
  OPT_std_f2008ts = 1907,                    /* -std=f2008ts */
  OPT_std_f2018 = 1908,                      /* -std=f2018 */
  OPT_std_f95 = 1909,                        /* -std=f95 */
  OPT_std_gnu = 1910,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1911, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1912, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1913,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1914,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1915,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1916, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1917, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1918,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1919,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1920, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1921, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1922,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1923,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1924,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1925, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1926, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1927,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1928, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1929,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1930,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1931, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1932, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1933,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1934, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1935, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1936, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1937, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1938, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1939,                     /* -std=legacy */
  OPT_stdlib_ = 1940,                        /* -stdlib= */
  OPT_symbol_ = 1941,                        /* -symbol= */
  OPT_symbolic = 1942,                       /* -symbolic */
  OPT_t = 1943,                              /* -t */
  OPT_time = 1944,                           /* -time */
  OPT_time_ = 1945,                          /* -time= */
  OPT_traditional = 1946,                    /* -traditional */
  OPT_traditional_cpp = 1947,                /* -traditional-cpp */
  OPT_tree_stats = 1948,                     /* -tree-stats */
  OPT_trigraphs = 1949,                      /* -trigraphs */
  OPT_type_stats = 1950,                     /* -type-stats */
  OPT_u = 1951,                              /* -u */
  OPT_undef = 1952,                          /* -undef */
  OPT_v = 1953,                              /* -v */
  OPT_version = 1954,                        /* -version */
  OPT_w = 1955,                              /* -w */
  OPT_wrapper = 1956,                        /* -wrapper */
  OPT_x = 1957,                              /* -x */
  OPT_z = 1958,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,

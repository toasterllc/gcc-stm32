...
enum opt_code
{
  ...
  OPT_fcyclomatic_complexity = 618,          /* -fcyclomatic-complexity */
  ...
  OPT_mabi_ = 1275,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1276,             /* -mabort-on-noreturn */
  OPT_mapcs = 1277,                          /* -mapcs */
  OPT_mapcs_frame = 1278,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1279,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1280,              /* -mapcs-stack-check */
  OPT_march_ = 1281,                         /* -march= */
  OPT_marm = 1282,                           /* -marm */
  OPT_masm_syntax_unified = 1283,            /* -masm-syntax-unified */
  OPT_mbe32 = 1284,                          /* -mbe32 */
  OPT_mbe8 = 1285,                           /* -mbe8 */
  OPT_mbig_endian = 1286,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1287,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1288,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1289,     /* -mcaller-super-interworking */
  OPT_mcmse = 1290,                          /* -mcmse */
  OPT_mcpu_ = 1291,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1292,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1293,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1294,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1295,                  /* -mfp16-format= */
  OPT_mfpu_ = 1296,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1297,             /* -mgeneral-regs-only */
  /* OPT_mhard_float = 1298, */              /* -mhard-float */
